...
API_ID = int(environ.get("API_ID", "32877320"))
API_HASH = environ.get("API_HASH", "a695364b4e43b600503d1e4a2bfdc085")
...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1002889685652").split()
]
...
# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://vinod974323_db_user:bmDLcs8ExE7T2yxX@cluster0.wln6cms.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get("DATABASE_NAME", "Cluster0")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://vinod974323_db_user:WzPOZVrHe4G31vCc@cluster0.v6grhvf.mongodb.net/?appName=Cluster0")
...
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1003544821271"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/SK_Moviesx")
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://i.ibb.co/x8MP5MD9/photo-2026-03-05-10-44-10-7613720643384639504.jpg",
    )
).split()
